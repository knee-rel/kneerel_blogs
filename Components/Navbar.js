          ...
          <div className="flex items-center justify-between">
            <div className="flex">
              ...
              <div className="dropdown inline-block relative mx-2">
                <span className="flex items-center hover:text-indigo-600 text-gray-800 dark:text-gray-50 mx-6 cursor-pointer">
                  <span className="text-xl font-semibold">
                ...
                <ul className="dropdown-menu absolute hidden text-gray-700 pt-1 bg-white dark:bg-dark w-40 pt-6 rounded-xl left-1/3">
                  {topics.map((topic) => (
                    <li key={topic}>
                      <Link
                        href={`/topic/${topic}`}
                        className="rounded-xl bg-white dark:bg-dark text-gray-800 dark:text-gray-50 py-2 px-4 block whitespace-no-wrap"
                      >
                        {topic}
                      </Link>
                    </li>
